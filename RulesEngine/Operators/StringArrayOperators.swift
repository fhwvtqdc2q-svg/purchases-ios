...
internal enum StringArrayOperators {
    ...
    static func opIn(
        ...
        let (needle, haystack) = try Operators.evalTwo(args, vars: vars, logger: logger, opName: "in")
    ...
    static func opCat(
        ...
        let evaluated = try Operators.evalArgs(args, vars: vars, logger: logger)
